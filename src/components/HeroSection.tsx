...
const HeroSection = () => {
  ...
  const ctaLink = 'https://backoffice.aurum.foundation/u/5CW428';
      ...
      <div className="container relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 animate-fade-up animation-delay-300">
              <Button 
                variant="hero" 
                size="xl" 
                className="group"
            ...
            {/* Trust Indicators */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 mt-12 animate-fade-up animation-delay-400">
          ...
          {/* Right Side - Premium Video */}
          <div className="lg:w-1/2 flex justify-center lg:justify-end animate-fade-up animation-delay-200">
            {/* Premium Frame Container */}
            <div className="relative w-full max-w-[560px]">
              {/* Outer Glow */}
              <div className="absolute -inset-4 bg-gradient-to-r from-primary/30 via-primary/15 to-primary/30 rounded-3xl blur-2xl" />
