      ...
      <div className="container">
        ...
        <div className="py-8 border-b border-background/10">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold mb-2 text-sm uppercase tracking-wider">Endereço</h4>
              <p className="text-sm text-background/60 leading-relaxed">
            ...
            <div>
              <h4 className="font-semibold mb-2 text-sm uppercase tracking-wider">Certificado</h4>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-background/60">
            Copyright 2025 | Aurum | Todos direitos reservados
          </p>
          <div className="flex items-center gap-6">
            ...
            <a 
              ...
              className="text-background/60 hover:text-[#25D366] transition-all duration-300 hover:scale-110" 
              aria-label="WhatsApp"
            >
